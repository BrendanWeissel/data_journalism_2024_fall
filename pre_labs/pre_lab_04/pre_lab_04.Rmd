...
**Answer** One example of places being listed differently preventing proper grouping is Whole foods. It is sometimes listed Whole Foods, Whole Foods Market, Whole Foods DC, etc. Another is with places with the word "and", sometimes it is the word and others it is "&". 
...
**Answer** Changed SCARLET OAK to Scarlet Oak in the first 20. That was the only change in the first 20. Outside the first 20 this is another change THE SALT LINE to	The Salt Line. 
...
**Answer** 
1. W. Millar & Co. to W. MILLAR & CO.
2. W.Millar & Company Catering to	W. MILLAR & CO. CATERING
3. Walmart to WALMART
...
```{r}
cleaned_dc_food <- read_csv("data/cleaned_dc_food.csv")
```
