...
**Answer** The code calculated the difference between unaffiliated voters from 2024 to 2022 for the top 10 counties with a positive change. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** A big blank canvas :(((
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** Now I see a bar chart showing the counties with largest change. The counties are ordered in alphabetic order. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** The chart is now ordered from least to greatest instead of alphabetical using reorder. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** The X and Y axis have flipped using coord_flip()
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** The colored background is removed by changing the theme of the chart with theme_minimal()
...
**Task** Run the following code. **Answer** thesmes loaded 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer** The theme is economist so there is a new theme. This has a blue background. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** A title for the grapgh, a title for the x and y axes and a caption was added. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** The breakdown of winred contributions by number of total contributions by day.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** A line chart shows the donation data by day. The X axis shows by month. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** This is similar to the last chart by now the X axis is showing by weeks. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** The labels on the X axis by week are at an angel to read it better. 
