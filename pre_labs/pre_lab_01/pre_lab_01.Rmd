...
last name - text - the surname of the person who donated money 
amount - dollars - he dollar value that was donated
...
**Answer** This is showing donations by date whereas head was showing the first 6 rows of data. This is a better way to sort data becasue it can show specific requests not only the first 6 rows. 
...
**Answer** We now see the days where there were the most donations. 05-31 was the most popular day
...
**Answer** the data is being grouped by donation destination to see how many donations went to each place by dollar amount. 
...
**Answer** Now we see that total amount donted by donation destination
...
**Answer** The data is now sorted by the mean and median amounts. Trump National Committee JFC is at the top of the results
...
Compared to the previous codeblock, what has changed and how did that affect the result? How is the data sorted? **Answer** Now the data is arranged by municiplaity that it has been donated from 
