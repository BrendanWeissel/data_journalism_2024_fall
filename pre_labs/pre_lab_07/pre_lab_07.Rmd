...
```{r echo=FALSE}
census_api_key("d7a6802c6d6385548be2d4392dca8527d20cc854", install=TRUE)
```
...
So let's try to answer a question using the Census. What is the fastest growing state since 2000? Nevada
...
**Task** Run the following codeblock to calculate the percentage change and put the state with the largest percentage growth below. **Answer** Nevada 35.1%
...
**Answer** 20816, 20854, 20817, 21029, 20777, 20896, 21737, 20841, 21738, 20818, 21036, 20837, 20833
...
**Task** Arrange md_zips_with_acs by estimate showing the highest median household income first. What questions do you have about these top zip codes? **Answer** What is a demographics of this place? race? age? how long have they lived in this location? how many people live at their residence? 
