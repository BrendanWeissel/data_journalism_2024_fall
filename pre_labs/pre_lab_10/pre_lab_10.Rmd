...
**Task** Run the following code to load data. Describe what you see in the answer space below. What columns exist in this data? **Answer** Boundaries for precincts and voting location in PG county. Also columns about map projections
...
**Task** Run the following code. Describe the output in the space below: what kind of information does it contain? **Answer**Boundaries for precincts and voting location in PG county. Also columns about map projections
...
**Task** Run the following code. Describe the output in the space below. **Answer** A map of the boundaries of preceincts in PG county
...
**Task** Run the following code. Describe the output in the space below. **Answer** tigris has been installed
...
**Task** Run the following code. Describe the output in the space below. **Answer** The dataset shows all U.S. counties and their mapping info
...
**Task** Run the following code. Describe the output in the space below. **Answer** Only MD counties are showing
...
**Task** Run the following code. Describe the output in the space below. **Answer**A map of the maryland counties is shown
...
**Task** Run the following code. Describe the output in the space below. **Answer** A map of the PG county precincts  is shown with some overlap at the county border.
...
**Task** Run the following code. Describe the output in the space below. **Answer** The dataset shows early voting data by precicnt
...
**Task** Run the following code. Describe the output in the space below. **Answer** The precinct data is joined with turnout data and they are joined by precinct. 
...
**Task** Run the following code. Describe the output in the space below. **Answer** A map of PG county by precinct is shown and weighted by voter turnout 
...
**Task** Run the following code. Describe the output in the space below. **Answer** A dataset with voter registration data by county
...
**Task** Run the following code. Describe the output in the space below. **Answer** Census data with population by county
...
**Task** Run the following code. Describe the output in the space below. **Answer** County mapping info with population
...
**Task** Run the following code. Describe the output in the space below. **Answer** County population is joined with voters by county data
...
**Task** Run the following code. Describe the output in the space below. **Answer** Cleaning county names
...
**Task** Run the following code. Describe the output in the space below. **Answer** A votes per 10k people in each county column is calculated
...
**Task** Run the following code. Describe the output in the space below. **Answer** A map of MD counties is shown with voter turnout by 10k with a color coded system by voters.
...
**Task** Run the following code. Describe the output in the space below. **Answer** The color scale is updated. 
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Answer** A log scale is added to the map for the colors. Easrern shore has a high turn out, near DC has a simialr turnout same with the counties right after the DC suburbs. 
...
**Task** Run the following code. Describe the output in the space below. **Answer** UNA voters are calculated by 10k people
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see, especially on the ends of the scale? **Answer** A map of UNA voters per 10k is shown. Baltimore city has a low UNA turnout, The northern part of the state has a decent tunrout as well. 
