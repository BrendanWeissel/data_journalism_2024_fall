...
```{r}
create_credentials(GROQ_API_KEY = "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")
```
...
**Answer** The names 11-20 are slightly less relevant and useful compared to 1-10. 
...
**Answer** Yes, it was able to extract the data asked for.
...
**Answer** Llama was accurate, I would change the prompt to provide specific requirements needed for the job. 
...
**Answer** No, there is an error because it cannot find the function.
...
**Answer** This provided an overview but is not super helpful to understand the data. 
