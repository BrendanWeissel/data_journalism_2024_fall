...
**Task** Run the following code in the gray-colored codeblock below to extract all tables in the HTML and save it as a dataframe. What do you notice about the columns? **Answer** They have full names and are not standardized. They are way too long as well. 
...
**Task** Run the following code to extract the table we want, clean up the names and remove the total row. Look at the rename() function - what do you think the numbers 2 through 6 are referring to? **Answer** The number of the column position so the column names can be cleaned. 
...
**Task** Run the following code in the gray-colored codeblock below to find the <li> tags. What does the output suggest about how many <ul> tags there are in the HTML source? **Answer** This suggests there are many ul tags as well becasue of the large numner of li tags. 
...
**Task** Run the following code in the gray-colored codeblock below to find the text inside <li> tags. Describe the output: **Answer** The output displays the 55 li tags and their titles 
...
**Answer** The urls of the committee names are nested within the title but there is not usable table
